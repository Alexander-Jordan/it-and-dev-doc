const posts = [
	...
	{
		title: 'How do I migrate a Sapper project to SvelteKit?',
		slug: 'How-do-i-migrate-a-sapper-project-to-sveltekit',
		html: `
			<p>The ONLY post that truly matters in this blog! Here you go: <a href='https://kit.svelte.dev/docs/migrating'>Migrating from Sapper</a></p>
		`
	}
];
